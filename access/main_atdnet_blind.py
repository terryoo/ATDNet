...
from model_atdnet_est_SP import denoiser # option: model_atdnet_est_single (single noise level) or model_atdnet_est_SP (spatially variant noise level)
from utils import *
...
def denoiser_test(denoiser):
    denoiser.test(args.test_set, args.noise_sigma, ckpt_dir=args.ckpt_dir, save_dir=args.result_dir)
